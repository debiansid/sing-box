...
by client and token, restores the original source, and updates checksums.
Fragment state is kept separately in a bounded LRU map. The programs retain the
Linux 4.19 4096-instruction ceiling.
