...
type ProviderRemoteOptions struct {
	...
	Exclude     *Regexp                    `json:"exclude,omitempty"`
	Include     *Regexp                    `json:"include,omitempty"`
	HealthCheck ProviderHealthCheckOptions `json:"health_check,omitempty"`
...
func (o *ProviderRemoteOptions) UnmarshalJSON(content []byte) error {
	err := json.UnmarshalDisallowUnknownFields(content, (*providerRemoteOptionsSchema)(o))
	if err != nil {
		return err
	}
