...
type GroupItem struct {
	...
	// Most recent IPv6-only probe; false on failure or when untested.
	// Groups report the currently selected underlying node.
...
type URLTestRequest struct {
	...
	// Independent from latency; a failed probe clears a prior positive result.
	Ipv6Test bool `protobuf:"varint,2,opt,name=ipv6Test,proto3" json:"ipv6Test,omitempty"`
	// Empty URL and zero timeout preserve server defaults.
...
type ProxyProvider struct {
	...
	Tag           string                     `protobuf:"bytes,1,opt,name=tag,proto3" json:"tag,omitempty"`
	Type          string                     `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`
	UpdatedAt     int64                      `protobuf:"varint,3,opt,name=updatedAt,proto3" json:"updatedAt,omitempty"` // Unix milliseconds; zero when unavailable.
...
type ProxyProviderSubscription struct {
	...
	Expire        int64                  `protobuf:"varint,4,opt,name=expire,proto3" json:"expire,omitempty"` // Unix seconds; zero when unavailable.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_daemon_started_service_proto_rawDesc = "" +
	"\n" +
	"\x1cdaemon/started_service.proto\x12\x06daemon\x1a\x1bgoogle/protobuf/empty.proto\"}\n" +
	"\aVersion\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12\x1e\n" +
	"\n" +
	"apiVersion\x18\x02 \x01(\x05R\n" +
	"apiVersion\x128\n" +
	"\x17proxyProvidersSupported\x18\x03 \x01(\bR\x17proxyProvidersSupported\"\xad\x01\n" +
	"\rServiceStatus\x122\n" +
	...
	"\x05items\x18\x06 \x03(\v2\x11.daemon.GroupItemR\x05items\"\xa3\x01\n" +
	"\tGroupItem\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12\x12\n" +
	...
	"\x04ipv6\x18\a \x01(\bR\x04ipv6J\x04\b\x06\x10\a\"~\n" +
	...
	"\x1bUSB_BACKEND_WINDOWS_VBOXUSB\x10\x042\xdb\x1c\n" +
	...
	"\x18HealthCheckProxyProvider\x12'.daemon.ProxyProviderHealthCheckRequest\x1a\x16.google.protobuf.Empty\"\x00\x12d\n" +
...
var file_daemon_started_service_proto_msgTypes = make([]protoimpl.MessageInfo, 109)
var file_daemon_started_service_proto_goTypes = []any{
	...
	(*ProxyProviderHealthCheckRequest)(nil),   // 19: daemon.ProxyProviderHealthCheckRequest
	(*SelectOutboundRequest)(nil),             // 20: daemon.SelectOutboundRequest
	(*SetGroupExpandRequest)(nil),             // 21: daemon.SetGroupExpandRequest
	(*ClashMode)(nil),                         // 22: daemon.ClashMode
	(*ClashModeStatus)(nil),                   // 23: daemon.ClashModeStatus
	(*SubscribeConnectionsRequest)(nil),       // 24: daemon.SubscribeConnectionsRequest
	(*ConnectionEvent)(nil),                   // 25: daemon.ConnectionEvent
	(*ConnectionEvents)(nil),                  // 26: daemon.ConnectionEvents
	(*Connection)(nil),                        // 27: daemon.Connection
	(*ProcessInfo)(nil),                       // 28: daemon.ProcessInfo
	(*CloseConnectionRequest)(nil),            // 29: daemon.CloseConnectionRequest
	(*DeprecatedWarnings)(nil),                // 30: daemon.DeprecatedWarnings
	(*DeprecatedWarning)(nil),                 // 31: daemon.DeprecatedWarning
	(*StartedAt)(nil),                         // 32: daemon.StartedAt
	(*OutboundList)(nil),                      // 33: daemon.OutboundList
	(*NetworkQualityTestRequest)(nil),         // 34: daemon.NetworkQualityTestRequest
	(*NetworkQualityTestProgress)(nil),        // 35: daemon.NetworkQualityTestProgress
	(*STUNTestRequest)(nil),                   // 36: daemon.STUNTestRequest
	(*STUNTestProgress)(nil),                  // 37: daemon.STUNTestProgress
	(*TailscaleStatusUpdate)(nil),             // 38: daemon.TailscaleStatusUpdate
	(*TailscaleEndpointStatus)(nil),           // 39: daemon.TailscaleEndpointStatus
	(*TailscaleUserGroup)(nil),                // 40: daemon.TailscaleUserGroup
	(*TailscalePeer)(nil),                     // 41: daemon.TailscalePeer
	(*TailscalePingRequest)(nil),              // 42: daemon.TailscalePingRequest
	(*TailscalePingResponse)(nil),             // 43: daemon.TailscalePingResponse
	(*SetTailscaleExitNodeRequest)(nil),       // 44: daemon.SetTailscaleExitNodeRequest
	(*TailscaleLogoutRequest)(nil),            // 45: daemon.TailscaleLogoutRequest
	(*TailscaleCertificateRequest)(nil),       // 46: daemon.TailscaleCertificateRequest
	(*TailscaleCertificate)(nil),              // 47: daemon.TailscaleCertificate
	(*TailscaleSSHClientMessage)(nil),         // 48: daemon.TailscaleSSHClientMessage
	(*TailscaleSSHStart)(nil),                 // 49: daemon.TailscaleSSHStart
	(*TailscaleSSHInput)(nil),                 // 50: daemon.TailscaleSSHInput
	(*TailscaleSSHResize)(nil),                // 51: daemon.TailscaleSSHResize
	(*TailscaleSSHServerMessage)(nil),         // 52: daemon.TailscaleSSHServerMessage
	(*TailscaleSSHAuthBanner)(nil),            // 53: daemon.TailscaleSSHAuthBanner
	(*TailscaleSSHReady)(nil),                 // 54: daemon.TailscaleSSHReady
	(*TailscaleSSHOutput)(nil),                // 55: daemon.TailscaleSSHOutput
	(*TailscaleSSHExit)(nil),                  // 56: daemon.TailscaleSSHExit
	(*TailscaleSSHError)(nil),                 // 57: daemon.TailscaleSSHError
	(*SubscribeTaildropInboxRequest)(nil),     // 58: daemon.SubscribeTaildropInboxRequest
	(*MarkTaildropInboxReadRequest)(nil),      // 59: daemon.MarkTaildropInboxReadRequest
	(*TaildropInbox)(nil),                     // 60: daemon.TaildropInbox
	(*TaildropFile)(nil),                      // 61: daemon.TaildropFile
	(*TaildropReceivingFile)(nil),             // 62: daemon.TaildropReceivingFile
	(*TaildropSendClientMessage)(nil),         // 63: daemon.TaildropSendClientMessage
	(*TaildropSendStart)(nil),                 // 64: daemon.TaildropSendStart
	(*TaildropOutgoingFile)(nil),              // 65: daemon.TaildropOutgoingFile
	(*TaildropFileChunk)(nil),                 // 66: daemon.TaildropFileChunk
	(*TaildropFileDone)(nil),                  // 67: daemon.TaildropFileDone
	(*TaildropSendServerMessage)(nil),         // 68: daemon.TaildropSendServerMessage
	(*TaildropSendProgress)(nil),              // 69: daemon.TaildropSendProgress
	(*DownloadTaildropFileRequest)(nil),       // 70: daemon.DownloadTaildropFileRequest
	(*DownloadTaildropFileChunk)(nil),         // 71: daemon.DownloadTaildropFileChunk
	(*DeleteTaildropFileRequest)(nil),         // 72: daemon.DeleteTaildropFileRequest
	(*CancelTaildropReceivingRequest)(nil),    // 73: daemon.CancelTaildropReceivingRequest
	(*USBProviderMessage)(nil),                // 74: daemon.USBProviderMessage
	(*USBServerMessage)(nil),                  // 75: daemon.USBServerMessage
	(*USBDeviceDescriptor)(nil),               // 76: daemon.USBDeviceDescriptor
	(*USBDeviceAttach)(nil),                   // 77: daemon.USBDeviceAttach
	(*USBInterface)(nil),                      // 78: daemon.USBInterface
	(*USBDeviceDetach)(nil),                   // 79: daemon.USBDeviceDetach
	(*USBDeviceReady)(nil),                    // 80: daemon.USBDeviceReady
	(*USBURBRequest)(nil),                     // 81: daemon.USBURBRequest
	(*USBURBResponse)(nil),                    // 82: daemon.USBURBResponse
	(*USBIsoPacket)(nil),                      // 83: daemon.USBIsoPacket
	(*USBEndpointAbort)(nil),                  // 84: daemon.USBEndpointAbort
	(*USBError)(nil),                          // 85: daemon.USBError
	(*USBIPServerStatusUpdate)(nil),           // 86: daemon.USBIPServerStatusUpdate
	(*USBIPServerStatus)(nil),                 // 87: daemon.USBIPServerStatus
	(*USBSharedDevice)(nil),                   // 88: daemon.USBSharedDevice
	(*OpenConnectStatusUpdate)(nil),           // 89: daemon.OpenConnectStatusUpdate
	(*OpenConnectEndpointStatus)(nil),         // 90: daemon.OpenConnectEndpointStatus
	(*OpenConnectTunnelInfo)(nil),             // 91: daemon.OpenConnectTunnelInfo
	(*OpenConnectAuthChallenge)(nil),          // 92: daemon.OpenConnectAuthChallenge
	(*OpenConnectAuthForm)(nil),               // 93: daemon.OpenConnectAuthForm
	(*OpenConnectAuthFormField)(nil),          // 94: daemon.OpenConnectAuthFormField
	(*OpenConnectAuthFormChoice)(nil),         // 95: daemon.OpenConnectAuthFormChoice
	(*OpenConnectBrowserRequest)(nil),         // 96: daemon.OpenConnectBrowserRequest
	(*OpenConnectBrowserCookie)(nil),          // 97: daemon.OpenConnectBrowserCookie
	(*OpenConnectBrowserHeader)(nil),          // 98: daemon.OpenConnectBrowserHeader
	(*OpenConnectAuthFormResponse)(nil),       // 99: daemon.OpenConnectAuthFormResponse
	(*OpenConnectBrowserResult)(nil),          // 100: daemon.OpenConnectBrowserResult
	(*OpenConnectAuthResponseSubmission)(nil), // 101: daemon.OpenConnectAuthResponseSubmission
	(*OpenConnectAuthChallengeCancel)(nil),    // 102: daemon.OpenConnectAuthChallengeCancel
	(*OpenVPNStatusUpdate)(nil),               // 103: daemon.OpenVPNStatusUpdate
	(*OpenVPNEndpointStatus)(nil),             // 104: daemon.OpenVPNEndpointStatus
	(*OpenVPNTunnelInfo)(nil),                 // 105: daemon.OpenVPNTunnelInfo
	(*OpenVPNChallenge)(nil),                  // 106: daemon.OpenVPNChallenge
	(*OpenVPNChallengeSubmission)(nil),        // 107: daemon.OpenVPNChallengeSubmission
	(*OpenVPNChallengeCancel)(nil),            // 108: daemon.OpenVPNChallengeCancel
	(*NotificationEvent)(nil),                 // 109: daemon.NotificationEvent
	(*Notification)(nil),                      // 110: daemon.Notification
	(*NotificationCancel)(nil),                // 111: daemon.NotificationCancel
	(*Log_Message)(nil),                       // 112: daemon.Log.Message
	nil,                                       // 113: daemon.OpenConnectAuthFormResponse.ValuesEntry
	(*emptypb.Empty)(nil),                     // 114: google.protobuf.Empty
}
var file_daemon_started_service_proto_depIdxs = []int32{
	4,   // 0: daemon.ServiceStatus.status:type_name -> daemon.ServiceStatus.Type
	112, // 1: daemon.Log.messages:type_name -> daemon.Log.Message
	...
	1,   // 8: daemon.ConnectionEvent.type:type_name -> daemon.ConnectionEventType
	27,  // 9: daemon.ConnectionEvent.connection:type_name -> daemon.Connection
	25,  // 10: daemon.ConnectionEvents.events:type_name -> daemon.ConnectionEvent
	28,  // 11: daemon.Connection.processInfo:type_name -> daemon.ProcessInfo
	31,  // 12: daemon.DeprecatedWarnings.warnings:type_name -> daemon.DeprecatedWarning
	13,  // 13: daemon.OutboundList.outbounds:type_name -> daemon.GroupItem
	39,  // 14: daemon.TailscaleStatusUpdate.endpoints:type_name -> daemon.TailscaleEndpointStatus
	41,  // 15: daemon.TailscaleEndpointStatus.self:type_name -> daemon.TailscalePeer
	40,  // 16: daemon.TailscaleEndpointStatus.userGroups:type_name -> daemon.TailscaleUserGroup
	41,  // 17: daemon.TailscaleEndpointStatus.exitNode:type_name -> daemon.TailscalePeer
	41,  // 18: daemon.TailscaleUserGroup.peers:type_name -> daemon.TailscalePeer
	49,  // 19: daemon.TailscaleSSHClientMessage.start:type_name -> daemon.TailscaleSSHStart
	50,  // 20: daemon.TailscaleSSHClientMessage.input:type_name -> daemon.TailscaleSSHInput
	51,  // 21: daemon.TailscaleSSHClientMessage.resize:type_name -> daemon.TailscaleSSHResize
	53,  // 22: daemon.TailscaleSSHServerMessage.authBanner:type_name -> daemon.TailscaleSSHAuthBanner
	54,  // 23: daemon.TailscaleSSHServerMessage.ready:type_name -> daemon.TailscaleSSHReady
	55,  // 24: daemon.TailscaleSSHServerMessage.output:type_name -> daemon.TailscaleSSHOutput
	56,  // 25: daemon.TailscaleSSHServerMessage.exit:type_name -> daemon.TailscaleSSHExit
	57,  // 26: daemon.TailscaleSSHServerMessage.error:type_name -> daemon.TailscaleSSHError
	61,  // 27: daemon.TaildropInbox.files:type_name -> daemon.TaildropFile
	62,  // 28: daemon.TaildropInbox.receiving:type_name -> daemon.TaildropReceivingFile
	64,  // 29: daemon.TaildropSendClientMessage.start:type_name -> daemon.TaildropSendStart
	66,  // 30: daemon.TaildropSendClientMessage.chunk:type_name -> daemon.TaildropFileChunk
	67,  // 31: daemon.TaildropSendClientMessage.fileDone:type_name -> daemon.TaildropFileDone
	65,  // 32: daemon.TaildropSendStart.files:type_name -> daemon.TaildropOutgoingFile
	69,  // 33: daemon.TaildropSendServerMessage.progress:type_name -> daemon.TaildropSendProgress
	77,  // 34: daemon.USBProviderMessage.attach:type_name -> daemon.USBDeviceAttach
	79,  // 35: daemon.USBProviderMessage.detach:type_name -> daemon.USBDeviceDetach
	82,  // 36: daemon.USBProviderMessage.urbResponse:type_name -> daemon.USBURBResponse
	80,  // 37: daemon.USBServerMessage.ready:type_name -> daemon.USBDeviceReady
	81,  // 38: daemon.USBServerMessage.urbRequest:type_name -> daemon.USBURBRequest
	84,  // 39: daemon.USBServerMessage.abort:type_name -> daemon.USBEndpointAbort
	85,  // 40: daemon.USBServerMessage.error:type_name -> daemon.USBError
	78,  // 41: daemon.USBDeviceDescriptor.interfaces:type_name -> daemon.USBInterface
	76,  // 42: daemon.USBDeviceAttach.descriptor:type_name -> daemon.USBDeviceDescriptor
	83,  // 43: daemon.USBURBRequest.isoPackets:type_name -> daemon.USBIsoPacket
	83,  // 44: daemon.USBURBResponse.isoPackets:type_name -> daemon.USBIsoPacket
	87,  // 45: daemon.USBIPServerStatusUpdate.servers:type_name -> daemon.USBIPServerStatus
	88,  // 46: daemon.USBIPServerStatus.devices:type_name -> daemon.USBSharedDevice
	76,  // 47: daemon.USBSharedDevice.descriptor:type_name -> daemon.USBDeviceDescriptor
	3,   // 48: daemon.USBSharedDevice.backend:type_name -> daemon.USBBackend
	2,   // 49: daemon.USBSharedDevice.state:type_name -> daemon.USBDeviceState
	90,  // 50: daemon.OpenConnectStatusUpdate.endpoints:type_name -> daemon.OpenConnectEndpointStatus
	92,  // 51: daemon.OpenConnectEndpointStatus.authChallenge:type_name -> daemon.OpenConnectAuthChallenge
	91,  // 52: daemon.OpenConnectEndpointStatus.tunnelInfo:type_name -> daemon.OpenConnectTunnelInfo
	93,  // 53: daemon.OpenConnectAuthChallenge.form:type_name -> daemon.OpenConnectAuthForm
	96,  // 54: daemon.OpenConnectAuthChallenge.browser:type_name -> daemon.OpenConnectBrowserRequest
	94,  // 55: daemon.OpenConnectAuthForm.fields:type_name -> daemon.OpenConnectAuthFormField
	95,  // 56: daemon.OpenConnectAuthFormField.options:type_name -> daemon.OpenConnectAuthFormChoice
	113, // 57: daemon.OpenConnectAuthFormResponse.values:type_name -> daemon.OpenConnectAuthFormResponse.ValuesEntry
	97,  // 58: daemon.OpenConnectBrowserResult.cookies:type_name -> daemon.OpenConnectBrowserCookie
	98,  // 59: daemon.OpenConnectBrowserResult.headers:type_name -> daemon.OpenConnectBrowserHeader
	99,  // 60: daemon.OpenConnectAuthResponseSubmission.form:type_name -> daemon.OpenConnectAuthFormResponse
	100, // 61: daemon.OpenConnectAuthResponseSubmission.browser:type_name -> daemon.OpenConnectBrowserResult
	104, // 62: daemon.OpenVPNStatusUpdate.endpoints:type_name -> daemon.OpenVPNEndpointStatus
	106, // 63: daemon.OpenVPNEndpointStatus.challenge:type_name -> daemon.OpenVPNChallenge
	105, // 64: daemon.OpenVPNEndpointStatus.tunnelInfo:type_name -> daemon.OpenVPNTunnelInfo
	110, // 65: daemon.NotificationEvent.send:type_name -> daemon.Notification
	111, // 66: daemon.NotificationEvent.cancel:type_name -> daemon.NotificationCancel
	0,   // 67: daemon.Log.Message.level:type_name -> daemon.LogLevel
	114, // 68: daemon.StartedService.GetVersion:input_type -> google.protobuf.Empty
	114, // 69: daemon.StartedService.SubscribeServiceStatus:input_type -> google.protobuf.Empty
	114, // 70: daemon.StartedService.SubscribeLog:input_type -> google.protobuf.Empty
	114, // 71: daemon.StartedService.GetDefaultLogLevel:input_type -> google.protobuf.Empty
	114, // 72: daemon.StartedService.ClearLogs:input_type -> google.protobuf.Empty
	7,   // 73: daemon.StartedService.SubscribeStatus:input_type -> daemon.SubscribeStatusRequest
	114, // 74: daemon.StartedService.SubscribeGroups:input_type -> google.protobuf.Empty
	114, // 75: daemon.StartedService.GetClashModeStatus:input_type -> google.protobuf.Empty
	114, // 76: daemon.StartedService.SubscribeClashMode:input_type -> google.protobuf.Empty
	22,  // 77: daemon.StartedService.SetClashMode:input_type -> daemon.ClashMode
	14,  // 78: daemon.StartedService.URLTest:input_type -> daemon.URLTestRequest
	20,  // 79: daemon.StartedService.SelectOutbound:input_type -> daemon.SelectOutboundRequest
	21,  // 80: daemon.StartedService.SetGroupExpand:input_type -> daemon.SetGroupExpandRequest
	24,  // 81: daemon.StartedService.SubscribeConnections:input_type -> daemon.SubscribeConnectionsRequest
	29,  // 82: daemon.StartedService.CloseConnection:input_type -> daemon.CloseConnectionRequest
	114, // 83: daemon.StartedService.CloseAllConnections:input_type -> google.protobuf.Empty
	114, // 84: daemon.StartedService.GetDeprecatedWarnings:input_type -> google.protobuf.Empty
	114, // 85: daemon.StartedService.GetStartedAt:input_type -> google.protobuf.Empty
	114, // 86: daemon.StartedService.SubscribeOutbounds:input_type -> google.protobuf.Empty
	114, // 87: daemon.StartedService.SubscribeProxyProviders:input_type -> google.protobuf.Empty
	18,  // 88: daemon.StartedService.UpdateProxyProvider:input_type -> daemon.ProxyProviderRequest
	19,  // 89: daemon.StartedService.HealthCheckProxyProvider:input_type -> daemon.ProxyProviderHealthCheckRequest
	34,  // 90: daemon.StartedService.StartNetworkQualityTest:input_type -> daemon.NetworkQualityTestRequest
	36,  // 91: daemon.StartedService.StartSTUNTest:input_type -> daemon.STUNTestRequest
	114, // 92: daemon.StartedService.SubscribeTailscaleStatus:input_type -> google.protobuf.Empty
	42,  // 93: daemon.StartedService.StartTailscalePing:input_type -> daemon.TailscalePingRequest
	44,  // 94: daemon.StartedService.SetTailscaleExitNode:input_type -> daemon.SetTailscaleExitNodeRequest
	45,  // 95: daemon.StartedService.TailscaleLogout:input_type -> daemon.TailscaleLogoutRequest
	46,  // 96: daemon.StartedService.GetTailscaleCertificate:input_type -> daemon.TailscaleCertificateRequest
	48,  // 97: daemon.StartedService.StartTailscaleSSHSession:input_type -> daemon.TailscaleSSHClientMessage
	58,  // 98: daemon.StartedService.SubscribeTaildropInbox:input_type -> daemon.SubscribeTaildropInboxRequest
	59,  // 99: daemon.StartedService.MarkTaildropInboxRead:input_type -> daemon.MarkTaildropInboxReadRequest
	63,  // 100: daemon.StartedService.SendTaildropFiles:input_type -> daemon.TaildropSendClientMessage
	70,  // 101: daemon.StartedService.DownloadTaildropFile:input_type -> daemon.DownloadTaildropFileRequest
	72,  // 102: daemon.StartedService.DeleteTaildropFile:input_type -> daemon.DeleteTaildropFileRequest
	73,  // 103: daemon.StartedService.CancelTaildropReceiving:input_type -> daemon.CancelTaildropReceivingRequest
	74,  // 104: daemon.StartedService.ProvideUSBDevices:input_type -> daemon.USBProviderMessage
	114, // 105: daemon.StartedService.SubscribeUSBIPServerStatus:input_type -> google.protobuf.Empty
	114, // 106: daemon.StartedService.SubscribeOpenConnectStatus:input_type -> google.protobuf.Empty
	101, // 107: daemon.StartedService.SubmitOpenConnectAuthResponse:input_type -> daemon.OpenConnectAuthResponseSubmission
	102, // 108: daemon.StartedService.CancelOpenConnectAuthChallenge:input_type -> daemon.OpenConnectAuthChallengeCancel
	114, // 109: daemon.StartedService.SubscribeOpenVPNStatus:input_type -> google.protobuf.Empty
	107, // 110: daemon.StartedService.SubmitOpenVPNChallengeResponse:input_type -> daemon.OpenVPNChallengeSubmission
	108, // 111: daemon.StartedService.CancelOpenVPNChallenge:input_type -> daemon.OpenVPNChallengeCancel
	114, // 112: daemon.StartedService.SubscribeNotifications:input_type -> google.protobuf.Empty
	5,   // 113: daemon.StartedService.GetVersion:output_type -> daemon.Version
	6,   // 114: daemon.StartedService.SubscribeServiceStatus:output_type -> daemon.ServiceStatus
	8,   // 115: daemon.StartedService.SubscribeLog:output_type -> daemon.Log
	9,   // 116: daemon.StartedService.GetDefaultLogLevel:output_type -> daemon.DefaultLogLevel
	114, // 117: daemon.StartedService.ClearLogs:output_type -> google.protobuf.Empty
	10,  // 118: daemon.StartedService.SubscribeStatus:output_type -> daemon.Status
	11,  // 119: daemon.StartedService.SubscribeGroups:output_type -> daemon.Groups
	23,  // 120: daemon.StartedService.GetClashModeStatus:output_type -> daemon.ClashModeStatus
	22,  // 121: daemon.StartedService.SubscribeClashMode:output_type -> daemon.ClashMode
	114, // 122: daemon.StartedService.SetClashMode:output_type -> google.protobuf.Empty
	114, // 123: daemon.StartedService.URLTest:output_type -> google.protobuf.Empty
	114, // 124: daemon.StartedService.SelectOutbound:output_type -> google.protobuf.Empty
	114, // 125: daemon.StartedService.SetGroupExpand:output_type -> google.protobuf.Empty
	26,  // 126: daemon.StartedService.SubscribeConnections:output_type -> daemon.ConnectionEvents
	114, // 127: daemon.StartedService.CloseConnection:output_type -> google.protobuf.Empty
	114, // 128: daemon.StartedService.CloseAllConnections:output_type -> google.protobuf.Empty
	30,  // 129: daemon.StartedService.GetDeprecatedWarnings:output_type -> daemon.DeprecatedWarnings
	32,  // 130: daemon.StartedService.GetStartedAt:output_type -> daemon.StartedAt
	33,  // 131: daemon.StartedService.SubscribeOutbounds:output_type -> daemon.OutboundList
	15,  // 132: daemon.StartedService.SubscribeProxyProviders:output_type -> daemon.ProxyProviderList
	114, // 133: daemon.StartedService.UpdateProxyProvider:output_type -> google.protobuf.Empty
	114, // 134: daemon.StartedService.HealthCheckProxyProvider:output_type -> google.protobuf.Empty
	35,  // 135: daemon.StartedService.StartNetworkQualityTest:output_type -> daemon.NetworkQualityTestProgress
	37,  // 136: daemon.StartedService.StartSTUNTest:output_type -> daemon.STUNTestProgress
	38,  // 137: daemon.StartedService.SubscribeTailscaleStatus:output_type -> daemon.TailscaleStatusUpdate
	43,  // 138: daemon.StartedService.StartTailscalePing:output_type -> daemon.TailscalePingResponse
	114, // 139: daemon.StartedService.SetTailscaleExitNode:output_type -> google.protobuf.Empty
	114, // 140: daemon.StartedService.TailscaleLogout:output_type -> google.protobuf.Empty
	47,  // 141: daemon.StartedService.GetTailscaleCertificate:output_type -> daemon.TailscaleCertificate
	52,  // 142: daemon.StartedService.StartTailscaleSSHSession:output_type -> daemon.TailscaleSSHServerMessage
	60,  // 143: daemon.StartedService.SubscribeTaildropInbox:output_type -> daemon.TaildropInbox
	114, // 144: daemon.StartedService.MarkTaildropInboxRead:output_type -> google.protobuf.Empty
	68,  // 145: daemon.StartedService.SendTaildropFiles:output_type -> daemon.TaildropSendServerMessage
	71,  // 146: daemon.StartedService.DownloadTaildropFile:output_type -> daemon.DownloadTaildropFileChunk
	114, // 147: daemon.StartedService.DeleteTaildropFile:output_type -> google.protobuf.Empty
	114, // 148: daemon.StartedService.CancelTaildropReceiving:output_type -> google.protobuf.Empty
	75,  // 149: daemon.StartedService.ProvideUSBDevices:output_type -> daemon.USBServerMessage
	86,  // 150: daemon.StartedService.SubscribeUSBIPServerStatus:output_type -> daemon.USBIPServerStatusUpdate
	89,  // 151: daemon.StartedService.SubscribeOpenConnectStatus:output_type -> daemon.OpenConnectStatusUpdate
	114, // 152: daemon.StartedService.SubmitOpenConnectAuthResponse:output_type -> google.protobuf.Empty
	114, // 153: daemon.StartedService.CancelOpenConnectAuthChallenge:output_type -> google.protobuf.Empty
	103, // 154: daemon.StartedService.SubscribeOpenVPNStatus:output_type -> daemon.OpenVPNStatusUpdate
	114, // 155: daemon.StartedService.SubmitOpenVPNChallengeResponse:output_type -> google.protobuf.Empty
	114, // 156: daemon.StartedService.CancelOpenVPNChallenge:output_type -> google.protobuf.Empty
	109, // 157: daemon.StartedService.SubscribeNotifications:output_type -> daemon.NotificationEvent
...
func file_daemon_started_service_proto_init() {
	...
	file_daemon_started_service_proto_msgTypes[87].OneofWrappers = []any{
	...
	file_daemon_started_service_proto_msgTypes[104].OneofWrappers = []any{
