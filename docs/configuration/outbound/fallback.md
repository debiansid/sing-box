...
List of outbound tags, in priority order. Outbounds listed here take priority over provider nodes.

#### providers

List of [Provider](/configuration/provider) tags. Provider nodes are appended after `outbounds` in priority order.
